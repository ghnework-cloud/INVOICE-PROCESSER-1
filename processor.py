...
def build_output_pdf(input_path, output_path, groups):
    ...
    # NEW RULES 28-AUG-2026
    (r"myn.*11.*x.*13|11x13.*myt|myn.*courier.*11|b0dnqh7r3c", "MY 11x13-100PC", "bags"),
    (r"b0f38n9sn3|8ft.*ropes.*black|cloths drying rope.*8ft|bungee.*cord.*8ft.*2", "B-12-2PC", "extension_cords"),
    (r"b0g5zg5k3w|butterfly.*7\.5.*silicon|butterfly.*senior.*7\.5|silicone.*gasket.*butterfly.*7\.5", "BUTTERFLY SILICON 7.5L", "gaskets"),
    (r"b0fd7p7pj1|pvc.*seat.*cover.*hinge|toilet.*seat.*hinge|plastic.*toilet.*seat", "PVC TOILET", "home_misc"),
    (r"b0f6v48kkk|caustic.*soda.*flakes.*1kg|caustic.*1kg|1kg.*caustic.*flakes", "C-1KG", "caustic_salt"),
    (r"b0fdwydjry|water.*tap.*aerator.*4|tap.*aerator.*pack.*4|brass.*aerator.*22mm", "F7A", "home_misc"),
    (r"b0dp9jgqv4|hathway.*remote.*i.*mod|hathway.*i.*modle", "HATHWAY I-MODE", "remotes"),
    (r"b0f6yrl437|cr2025.*3v.*3|cr2025.*pack.*3|qcg.*cr2025.*3v_3", "2025-3PC", "batteries"),
    (r"b0dphdb3zj|lr44.*ag13.*100|lr.*44.*tray.*100|ag13.*100b", "LR44=100PC", "batteries"),
    (r"b0dz2mmw4r|lr41.*ag3.*4|lr41.*pack.*4|dx-vg7v", "LR41-4PC", "batteries"),
    (r"b0f6yrp87x|lr1130.*ag10.*4|qcg.*lr1130.*189_4", "1130-4PC", "batteries"),
    (r"b0f6yr1wpq|a23.*battery.*5|qcg.*a23.*23a_5|23a.*pack.*5", "23A-5PC", "batteries"),
    (r"b0dphdn1qc|a23.*battery.*23a_5b|copy.*line.*a23.*5", "23A-5PC", "batteries"),
    (r"b0dwfpxnj1|mvh.*ecom.*23a.*2|fn-5vep-ktuc|23a.*12v.*2", "23A=2PC", "batteries"),
    (r"b0drzywpmt|dm-glyy-u74z|courier.*bag.*8.*x.*10.*100|s.*8x10.*100", "S-8x10=100PC", "bags"),
    (r"b0g5z9f4f2|blue.*vinod.*5.*ltr|vinod.*5l.*gasket", "BLUE VINOD 5L", "gaskets"),
    (r"b0gd6gn8q4|stah.*5ltr|stahl.*5.*liter|stahl.*cooker.*5", "STAHL 5L", "gaskets"),
    (r"b0gd6qy5yp|stah.*3ltr|stahl.*3.*liter|stahl.*cooker.*3", "STAHL 3L", "gaskets"),
    (r"b0fdggd8lv|7e-09wt-e1vt|coal.*disc.*dhoop.*33mm.*5", "YELLOW-50", "coal"),
    (r"b0fdgf8jr3|a6-wc4l-oauz|coal.*disc.*dhoop.*3.*roll", "YELLOW-30", "coal"),
    (r"lr41.*25|ag3.*sr41.*25|button.*coin.*cell.*25", "LR41-25PC", "batteries"),
