...
RULES = [
    ...
    ("YELLOW - 30",  ["b0f2ybp3mq", "n0-i890-y72k", "b0fdgf8jr5", "a6-wc4l-oau2",
                      ...
                      "pack of 3 rolls", "45+ minutes burn", "long burning coal for dhoop"],     ["caustic", "koyla", "gasket", "battery", "courier",
                                                                                   "b0f2y75m27", "b0f5bs8pss", "b0f2ntp6lb"]),
    ("YELLOW - 50",  ["gf-f04m-k04x", "b0f2ynnx2g", "b0f79tsnyj", "b9-owuq-q92g",
                       "al-afandi nara charcoal", "smokeless and odourless", "100 pieces (5)",
                      "bakhoor dani magic coal pack of 5", "pack of 5 rolls (50 discs)"],                       ["caustic", "koyla", "gasket", "battery", "courier",
                                                                                   "b0f2ybp3mq", "b0f2y75m27", "b0f5bs8pss"]),
    ("YELLOW - 100", ["b0f2y75m27", "b0f2y75mz7", "b0fdghb28w", "bf-1m6x-74j1",
                      "nn-wb0x-ogx9", "bakhoor dani magic coal pack of 10",
                      "pack of 10 rolls (100 discs)"],                      ["caustic", "koyla", "gasket", "battery", "courier",
                                                                                   "b0f2ybp3mq", "b0f5bs8pss"]),
    ...
    ("K-50",      ["5 rolls (50 discs)", "50 discs", "gf-f04m-k04x",
    ...
    ("K-60",      ["6 rolls (60 discs)", "60 discs", "b0f4pcgjpb",
                   "b0f5brp99x", "6v-k4i1-tbr7", "pack of 6 roll (60 disc)",
                   "6 roll (60 disc)", "magic coal 6 roll",
    ...
    ("K-100",     ["10 rolls (100 discs)", "100 discs", "bf-1m6x-74j1",
    ...
    ("SILICON 77",  ["b0gbvl1l8w", "b0h2vfhrj2", "silicon 77 )", "only for pigeon aluminium",
                     "silicon 77 )", "silicon 77",
    ...
    ("1.5 LITER INNER LID 2 PC",     ["b0f9vk3dby", "1.5 liter inner lid 2 pc", "1.5 litre capacity",
                       ...
                       "hawkiins", "hawkins", "13 cm inner lid"],                ["butterfly", "vinod", "pigeon", "popular", "caustic",
                                                                                   "silicon", "triply", "3 liter", "5 litre butterfly", "5l butterfly"]),
    ("SILICON VINOD 3L", ["b0gdqc9y8t", "silicon outer lid rubber gasket compatible for 3 litre vinod",
                           "silicon vinod 3", "silicon vinod 3 ltr"],            ["butterfly", "pigeon", "popular", "caustic",
                                                                                    "handi", "vibrantangan"]),
    ...
    ("BUTTERFLY SILICON 5L",  ["5&5.5 litre butterfly", "5 litre butterfly",
                               ...
                               "b0fxy5cmvn", "5&5.5 litre butterfly silicon",
                                "b0gxdqn8fk",
    ...
    # Vinod gaskets
    ("HANDI VINOD 3.5L", ["b0g71y9s7l", "handi vinod 3.5 ltr",
                         "vinod splendid plus handi cooker, 3.5 liter",
                         "stainless steel outer lid pressure cooker replacement seal"],
                                                                               ["1.5", "caustic", "battery", "courier"]),
    ("VINOD HANDI 1.5L", ["vinod splendid plus handi", "b0g72fs1l1", "b0g72fb1l1",
                          "vinod handi 1.5ltr", "silicon gasket 1.5 liter vinod splendid",
                        "silicon gasket for 1.5 liter vinod",
                        "silicon gasket for 1.5 litre vinod splendid",
                           "vinod handi 1.5", "handi vinod 1.5"],               ["butterfly", "pigeon", "popular", "caustic",
                                                                                  "3 litre", "vibrantangan", "dhoop", "coal", "2.5"]),
    ("VINOD HANDI 2.5L", ["vinod plus handi cooker", "b0g71hxgrx",
                           "handi vinod 2.5ltr", "vinod handi 2.5",
                           "2.5 liter vinod"],                                  ["butterfly", "pigeon", "popular", "caustic",
    ...
    ("VINOD 3L",   ["vinod stainless", "vinod 3 litre", "b0f8lgj2hn",
                    ...
                    "b0h1f7pfzg", "blue vinod 3ltr"],                            ["butterfly", "pigeon", "popular", "caustic",
    ...
    ("VINOD 5L",   ["b0g5z9f4f2", "blue vinod 5", "vinod 5l",
                    ...
                    "only for steel cooker", "blue vinod 5 ltr"],               ["butterfly", "pigeon", "popular", "caustic",
    ...
    ("NSB 12x15",  ["b0gw2kh6rk", "hk-su5t-zipz", "12.5x15 nsb3",
                      "courier bag 12.5x15", "nsb3 with qr", "12x15"],         ["14x18", "10x13", "8.5x11", "caustic"]),
    ...
    ("S- 8x10 = 100PC",["b0drzywpmt", "dm-giyy-u74z", "(100, 8 x 10)",
                        "courier bag 8 x 10", "polybags for shipping/packing (100, 8 x 10)"],
                                                                               ["50pc", "7x10", "caustic", "gasket"]),
    ("S- 10x12 = PC", ["tc-2dxv", "(100, 10 x 12)", "b0drzylgps", "b0drzyfghf", "tc-2dxv-yykv",
                       "73-g0ob-sk9r", "(50, 10 x 12)"],                         ["tsb", "nsb", "myn", "flipkart", "flip-kart"]),
    ("SNAP DEAL 14.5x17", ["b0f843xd28", "packing bag sk pod 52 micron 14.5x17",
                           "14.5x17_100", "14.5 x17"],                          ["7x7", "7 x 7", "caustic", "gasket"]),
    ("SNAP DEAL 7X7",  ["b0fb48bq9x", "52 micron 7x7", "packing bag sk pod 52 micron 7x7",
                        "snap deals packing bag sk pod", "7x7"],                ["tsb", "nsb", "myn", "flipkart", "flip-kart",
                                                                                  "12x14", "10x12", "8x12", "6x8"]),
    ("S- 12x14 = PC", ["b0f8461jkn", "52 micron 12x14",
    ...
    ("S- 6.5x8 = PC", ["7l-ewwi-6mhn", "b0drzz6h3b", "b0drzz0h3b", "(50, 6.5 x 8)",
    ...
    ("AJO TAPE 12PC",["b0dnt6987n", "ajios tape", "copy line ajios tape",
                       "2 inch (65m)", "tape 2 inch (65m"],                    ["bag", "packing bag", "courier", "gasket"]),
    ("AJO 13x17",   ["printed packing bag 13x17", "b0dnmg4s11",
                     "pj05", "printed packing bag 14x18", "ajios printed"],                       ["tsb", "nsb", "myn", "flipkart", "flip-kart"]),
    ...
    ("27 A = 5PC",    ["27a_alkaline", "27a 5 pc", "27ae-2c5", "a27 /v27ga",
                       "v27ga /mn27", "b0drcxf2lz"],                            ["lr1130", "sr416", "sr616", "ag10", "lr41", "watch battery",
                                                                                  "caustic", "gasket", "courier", "23a", "a23"]),
    ("23 A = 5PC",          ["b0f6yr1wpq", "qcg a23 battery 23a_5",
                              "mn21 lrv08 gp 23ae", "23a s-pack of 5"],         ["fn-5vep-ktuc", "2pc", "pack of 2", "caustic", "gasket"]),
    ("23 A = 2PC",          ["23a 12v alkaline", "a23/v23ga/mn21", "b0dwfpxnj1",
                       "mn21", "v23ga"],                                         ["lr1130", "sr416", "sr616", "ag10", "lr41", "watch battery",
                                                                                  "caustic", "gasket", "courier", "27ae", "27a_alkaline"]),
    ("LR44 = 50PC",   ["b0dz2lbld4", "li-b17k-494g", "lr44 ag13 button cell batteries pack of 50",
                       "pack of 50", "compatible with led candle"],             ["25pc", "lr1130", "27a", "caustic", "gasket"]),
    ...
    ("1130 = 4PC",    ["b0f6yrp87x", "b0dphdqqhb", "qcg_r1130 ag10 189_4", "qcg lr1130 ag10 189_4",
                       "lr1130 ag10 189_4", "ag10 189_4", "lr1130 ag10 189",
                       "lr1130 ag10 189_4b", "copy line lr1130 ag10 189",
                       "ag10 189 1.5v alkaline button cell", "pack of 4"],      ["lr41", "sr41", "tray packing", "25b", "27a", "23a", "caustic", "gasket"]),
    ("LR41 = 4PC",    ["b0dz2mmw4r", "dx-vg7v-7uo1", "lr41 ag3 lr736 392",
                       "thermometer (4)", "electronic toys digital thermometer",
                       "lr41 battery ag3", "sr41 1.5v alkaline button coin cell electronics",
                       "thermometer (4)"],                                       ["lr1130", "sr616sw", "ag10 189 1.5v", "27a alkaline", "23a 12v", "caustic", "gasket", "courier"]),
    ("LR41 = 25PC",   ["b0dphctwz3", "lr41 battery ag3 tray packing_25b",
                       "lr41 ag3 sr41 tray packing", "tray packing_25b"],        ["lr1130", "ag10 189", "1130", "27a", "23a", "caustic", "gasket", "courier"]),
    ("1130 = 25PC",   ["lr1130", "sr616sw",
                       "321 silver oxide", "lr1130 ag10 189 1.5v",
                       "b0f6ysgpm9", "b0f9vmh4gt"],                             ["27a_alkaline", "23a 12v", "caustic", "gasket", "courier", "bungee", "b0dz2mmw4r", "thermometer",
    ...
    ("920 = 2PC",     ["sr920sw", "371 silver oxide", "b0f895nzjj",
                       "sr920sw 371 2 pc"],                                      ["lr1130", "sr416", "sr936", "lr44", "27a_alkaline",
                                                                                   "caustic", "gasket", "courier"]),
    ("927 = 4PC",     ["b0fyq5jhl7", "2c-7hl2-kdpu", "sr927sw 395 silver oxide",
                       "premium sr927sw 395 silver oxide watch battery",
                       "mercury-free. made in japan. (4)"],                    ["sr626sw", "lr44", "lr41", "caustic", "gasket"]),
    ("927 = 2PC",     ["sr927sw", "395 silver oxide", "b0f9vm3wk2",
                       "3r-pygc-8bpd"],                                          ["lr1130", "sr416", "sr936", "lr44", "27a_alkaline",
                                                                                   "caustic", "gasket", "courier"]),

    ("626 = 2PC",     ["b0dphcfp87", "sr626sw 377 button cell", "pack of 2",
                       "sr626sw 377 button cell_2b"],                           ["lr1130", "sr416", "sr936", "lr44", "27a_alkaline",
                                                                                  "caustic", "gasket", "courier", "5pc", "b0f8crxtb4"]),
    ...
    ("B- 6FT = PC",   ["b0gknqtqjj", "gj-6djh-32uf", "b0h33vfwfc", "(6 feet) pack",
                       "b0h25mzfgm", "b0h33vfwfc",
    ...
    ("B- 12FT + 15FT", ["b0dnw255dw ( 15ft"],                                   ["caustic", "gasket", "battery", "courier", "multicolour",
                                                                                   "pack 2", "b0f38jwkj4"]),
    ("B-12-1PC",     ["b0dnw1ph19", "b0dnw2s5vf", "copy line 2 meter", "2 meter ropes",
                       "12ft ropes multicolour", "12 ft cloths drying ropes", "multicolour_1",
                       "black colour) | bungee cord", "pack of 1"],             ["caustic", "gasket", "battery", "courier", "multicolour",
                                                                                   "10 ft", "15 ft", "6 ft", "(5 ft)", "pack of 11"]),
    ("B-12-2PC",     ["b0dnw1ph19", "pack of 11", "2 meter ropes",
                       "copy line 2 meter", "black colour) | bungee cord"],     ["caustic", "gasket", "battery", "courier", "multicolour",
                                                                                   "10 ft", "15 ft", "6 ft", "(5 ft)"]),
    ...
    ("HATHWAY ANADA REMOTE", ["b0dp9ll4d4", "anda shap compatible hathway",
                              "hathway remote(anda remote)", "andha remote"],   ["caustic", "gasket", "battery", "i modle"]),
    ("HATHWAY I REMOTE",  ["b0dp9jgqv4", "i modle compatible for hathway",
                              "hathway remote(i modle)", "i modle_1"],          ["caustic", "gasket", "battery", "anda"]),
    ...
    ("HALF TURN SPINDLE", ["b0f8b9b7cc", "half turn sp", "half turn spindle",
                            "brass ceramic quarter turn", "quarter turn disc cartridge",
                            "3/4 inch pack of 1", "angle cock"],               ["caustic", "gasket", "battery", "courier"]),
    ...
    ("BRUSH",         ["brush", "scrub brush", "cleaning brush", "dish brush",
                       "b0gkqnc8l8", "screen brush", "mesh cleaning brush",
                       "multifunctional screen brush", "2 in 1 mesh cleaning",
                       "screen brush", "mesh cleaning brush", "toilet brush",
                       "bottle brush", "floor brush", "wash brush"],            ["caustic", "gasket", "battery", "courier", "bungee"]),
    ("INDIAN FLAG",   ["indian flag", "b0dtk2l3q1", "har ghar tiranga",
                       "24 x 36 inches", "2 x 3 ft polyester"],               ["caustic", "gasket", "battery", "courier", "bungee"]),
    ("PVC TOILET",    ["pvc toilet seat", "toilet seat hinge", "b0dsg5kbt1",
    ...
    ("POUCH",          ["b0f2n8ywbp", "1h-0kkl-cvs8", "multipurpose storage pouches",
                        "jewelry organizer", "ziplock pouch", "golden, meduim"],["caustic", "gasket", "battery", "courier", "bungee"]),
    ("MISC",          ["screen brush", "mosquito net", "mesh cleaning brush",
                       ...
                       "polyester with double-sided printing",
...
SORT_ORDER = [
    ...
    'SURYA 3L', 'SURYA 4-5L',
    '77', 'BUTTERFLY SILICON 2-3L', 'BUTTERFLY SILICON 5L',
    'STAHL 5L', 'STAHL 3L',
    '777', 'VINOD 5L', 'HANDI VINOD 3.5L', 'VINOD HANDI 1.5L', 'VINOD HANDI 2.5L', 'VINOD 3L', 'SILICON VINOD 3L',
    'TSB 6x7', 'TSB 8.5x11', 'TSB 10x13', 'TSB 14x17',
    'NSB 6x8', 'NSB 8.5x11', 'NSB 10x13', 'NSB 12x15', 'NSB 14x18', 'NSB 16x20',
    'S- 6x8 - 50PC', 'S- 6.5x8 = PC', 'S- 7x10 = PC', 'S- 7x10 - 50PC', 'S- 8x10 = PC',
    'S- 8x11 = PC', 'S- 8x12 = PC',
    'S- 8x10 = 100PC', 'S- 10x12 = PC', 'S- 10x14 - 50PC', 'SNAP DEAL 14.5x17', 'SNAP DEAL 7X7', 'S- 12x14 = PC', 'S- 12x16 = PC',
    'S- 13x14 = PC', 'S- 14x17 - 50PC', 'S- 14x18 = PC', 'S- 15x19 = PC',
    'S- 18x23 - 50PC', 'S- 18x23 = PC',
    'AMAZON 6x8 - 100PC', 'AMAZON 10x12', 'AMAZON 11x13', '6x8 = PC', 'AJO TAPE 12PC', 'AJO 13x17', 'ZIP BAG 5X6',
    ...
    '27 A = 2PC', '27 A = 5PC', '23 A = 5PC', '23 A = 5PC', '23 A = 2PC', 'LR41 = 4PC', 'LR41 = 25PC', '1130 = 4PC', '1130 = 25PC', '416 = 5PC', 'SR936 = 5PC',
    ...
    'HATHWAY ANADA REMOTE', 'HATHWAY I REMOTE', 'HATHWAY ANADA REMOTE', 'HATHWAY I REMOTE', 'HATHWAY REMOTE', 'WHIRLPOOL REMOTE', 'DAIKIN REMOTE',
    ...
    'FTA', 'HALF TURN SPINDLE', 'MARLEX 11 LTR', 'GARBAGE BAG', 'BRUSH', 'INDIAN FLAG', 'PVC TOILET', 'JIGGER SET', 'POUCH', 'MISC', 'UNCLASSIFIED',
]
